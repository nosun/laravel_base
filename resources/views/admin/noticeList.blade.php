        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="widget-box " style="margin:0px">
                    ...
                    @foreach ($list as $row )
                        <tr>
                            <input id="notice_{{$row->id}}" type="hidden" value="{{$row->notice}}">
                            <td>{{$row->notice}}</td>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group">
                                <label for="description" class="col-sm-3 control-label">首页公告</label>
                                <div class="col-xs-12 col-sm-6">
                                    <textarea type="text" class="form-control" name="notice" required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $('#edit-form').on('show.bs.modal', function (event) {
            ...
            if (value == 'edit') {
                ...
                var methord = 'put';
                modal.find("textarea[name='notice']").val($('#notice_' + id).val());
            }
